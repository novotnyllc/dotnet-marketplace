...
**Size:** M
**Files:** `agents/dotnet-blazor-specialist.md`, `agents/dotnet-architect.md`, `agents/dotnet-csharp-concurrency-specialist.md`, `agents/dotnet-performance-analyst.md`
...
- **Mads Torgersen** (C# language design) → enrich `dotnet-csharp-concurrency-specialist` or relevant C# skills with language design rationale references. C# Language Design Notes as source.
- **Andrew Lock** (ASP.NET Core config, middleware) → fold into the new `dotnet-aspnetcore-specialist` (fn-38.2) and relevant middleware skills. Blog series as source.
...
- [ ] Mads Torgersen C# language design rationale referenced in relevant agents/skills
