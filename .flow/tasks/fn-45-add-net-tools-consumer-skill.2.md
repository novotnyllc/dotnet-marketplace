...
## Description
Register `dotnet-tool-management` in plugin.json, add routing entry in `dotnet-advisor`, and add cross-references to/from `dotnet-cli-packaging` and `dotnet-cli-distribution`.

**Size:** S
**Files:** `.claude-plugin/plugin.json`, `skills/foundation/dotnet-advisor/SKILL.md`, `skills/cli-tools/dotnet-cli-packaging/SKILL.md`, `skills/cli-tools/dotnet-cli-distribution/SKILL.md`
