...
description: "WHEN automating benchmark regression detection. Baseline management, GitHub Actions integration, threshold alerts, BenchmarkDotNet CI workflows."
---
