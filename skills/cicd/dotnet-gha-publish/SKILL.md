...
**Out of scope:** Container image authoring (Dockerfile, base image selection) -- see [skill:dotnet-containers] (fn-5). Native AOT MSBuild configuration -- see [skill:dotnet-native-aot] (fn-16). CLI release pipelines -- see [skill:dotnet-cli-release-pipeline] (fn-17). Starter CI templates -- see [skill:dotnet-add-ci] (fn-4). Azure DevOps publishing -- see `dotnet-ado-publish` (fn-19). Deployment to target environments -- see `dotnet-gha-deploy` (fn-19).
