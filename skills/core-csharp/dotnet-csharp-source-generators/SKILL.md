...
public sealed class AutoNotifyGenerator : IIncrementalGenerator
{
    public void Initialize(IncrementalGeneratorInitializationContext context)
    {
        ...
        // Step 2: Combine with compilation if needed
        ...
        SourceProductionContext context)
    {
        foreach (var field in fields.Distinct())
        {
            ...
            var source = $$"""
                ...
                namespace {{field.ContainingNamespace}};
                    ...
                    : System.ComponentModel.INotifyPropertyChanged
                {
                    ...
                    public {{field.FieldType}} {{propertyName}}
                    {
                        ...
                        set
                        {
                            if (!EqualityComparer<{{field.FieldType}}>.Default.Equals({{field.FieldName}}, value))
                            {
            ...
            context.AddSource($"{field.ClassName}.{propertyName}.g.cs", source);
        }
    }
...
Report errors and warnings through `SourceProductionContext` rather than throwing exceptions.
