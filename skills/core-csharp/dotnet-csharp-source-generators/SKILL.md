...
public sealed class AutoNotifyGenerator : IIncrementalGenerator
{
    ...
    {
        // Group by containing type to emit one file per class
        foreach (var group in fields.GroupBy(f => (f.Namespace, f.ClassName)))
        {
            ...
            context.AddSource($"{className}.AutoNotify.g.cs", source);
        }
    }
